...
<div class="section-header-back">
    <a href="{{ route('cp.home-menus.submenus.show', [$parent, $menu]) }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
</div>
<h1>Edit Submenu</h1>
<div class="section-header-breadcrumb">
    ...
    @endforeach
    <div class="breadcrumb-item"><a href="{{ route('cp.home-menus.submenus.show', [$parent, $menu]) }}">{{ $menu->title }}</a></div>
    <div class="breadcrumb-item active">Edit Submenu</div>
</div>
@endsection

@section('content')
<form action="{{ route('cp.home-menus.submenus.update', [$parent, $menu]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer bg-whitesmoke">
                    ...
                    <a href="{{ route('cp.home-menus.submenus.show', [$parent, $menu]) }}" class="btn btn-secondary">
                        Batal
                    </a>
                </div>
            </div>
