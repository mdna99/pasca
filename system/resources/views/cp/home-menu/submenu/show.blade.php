...
<div class="section-header-back">
    ...
    <a href="{{ route('cp.home-menus.show', $parent) }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
    @else
    <a href="{{ route('cp.home-menus.submenus.show', [$parent->parent_id, $parent]) }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
    @endif
</div>
<h1>Detail Menu</h1>
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item {{ $loop->last ? 'active' : '' }}"><a href="{{ $breadcrumb->parent_id == 0 ? route('cp.home-menus.show', $breadcrumb->id) : route('cp.home-menus.submenus.show', [$breadcrumb->parent_id, $breadcrumb->id]) }}">{{ $breadcrumb->title }}</a></div>
    @endforeach
</div>
@endsection
...
<div class="card d-flex" style="height: 100%; background: linear-gradient(to left, rgba(255,255,255,0),
    ...
    <div class="card-wrap">
        <div class="card-body">
            ...
            <a href="{{ route('cp.home-menus.submenus.edit', [$parent, $menu]) }}" class="btn btn-sm btn-light" style="position: absolute; right: 10px; top: 10px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
