...
@section('content')
<form action="{{ route('cp.home-menus.store') }}" method="POST" enctype="multipart/form-data">
    @csrf
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade active show" id="id" role="tabpanel" aria-labelledby="id-tab">
                            ...
                            <div class="form-group">
                                ...
                                <textarea style="height: 100px;" id="description_id" class="form-control{{ $errors->has('description_id') ? ' is-invalid' : '' }}" name="description_id" autofocus="" placeholder="Deskripsi dalam bahasa Indonesia">{{ old('description_id') }}</textarea>
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer bg-whitesmoke">
                    ...
                    <a href="{{ route('cp.home-menus.index') }}" class="btn btn-secondary">
                        Batal
                    </a>
                </div>
            </div>
