...
<div class="section-header-breadcrumb">
    ...
    <div class="breadcrumb-item active">Main Menu</div>
</div>
@endsection
...
<div class="d-flex justify-content-between align-items-center mb-2">
    ...
    <a href="{{ route('cp.main-menus.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> Tambah Menu</a>
</div>
<div class="row">
    ...
    <div class="col-md-4">
        <div class="article">
            <div class="article-header">
                ...
                <a href="{{ route('cp.main-menus.edit',$menu) }}" class="btn btn-sm btn-primary" style="position: absolute; top: 10px; right: 45px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil-alt"></i></a>
                <form id="form-action" method="POST" action="{{ route('cp.main-menus.destroy', $menu) }}" accept-charset="UTF-8">
                    @method('DELETE')
                    @csrf
            ...
            <div class="card-footer bg-whitesmoke px-2">
                <a href="{{ route('cp.main-menus.show',$menu) }}" class="btn btn-sm btn-warning w-100"><i class="fa fa-eye"></i> Detail</a>
            </div>
        </div>
    </div>
    @empty
