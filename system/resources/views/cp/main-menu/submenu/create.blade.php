...
<div class="section-header-back">
    <a href="{{ $menu->parent_id == 0 ? (route('cp.main-menus.show', $menu)) : (route('cp.main-menus.submenus.show', [$menu->parent_id, $menu])) }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
</div>
...
@section('content')
<form action="{{ route('cp.main-menus.submenus.store', $menu) }}" method="POST" enctype="multipart/form-data">
    @csrf
        ...
        <div class="col-md-4">
            <div class="card">
                ...
                <div class="card-footer bg-whitesmoke">
                    ...
                    <a href="{{ $menu->parent_id == 0 ? (route('cp.main-menus.show', $menu)) : (route('cp.main-menus.submenus.show', [$menu->parent_id, $menu])) }}" class="btn btn-secondary">
                        Batal
                    </a>
                </div>
            </div>
