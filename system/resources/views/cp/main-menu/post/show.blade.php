...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            <a href="{{ route('cp.main-menus.posts.edit', [$menu, $post]) }}" class="btn btn-sm btn-primary" style="position: absolute; top: 8px; right: 8px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit"><i class="fa fa-pencil-alt"></i></a>
