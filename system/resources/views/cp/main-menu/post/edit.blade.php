...
<div class="section-header-breadcrumb">
    ...
    @endforeach
    <div class="breadcrumb-item"><a href="{{ route('cp.main-menus.posts.show', [$menu, $post]) }}">{{ $post->title }}</a></div>
    <div class="breadcrumb-item active">Edit Post</div>
</div>
@endsection

@section('content')
<form action="{{ route('cp.main-menus.posts.update', [$menu, $post]) }}" method="POST" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="row">
        <div class="col-md-8">
