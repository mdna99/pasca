...
<div class="section-header-back">
    <a href="{{ route('cp.secondary-menus.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
</div>
<h1>Detail Menu</h1>
...
<div class="card d-flex" style="height: 100%; background: linear-gradient(to left, rgba(255,255,255,0),
    ...
    <div class="card-wrap">
        <div class="card-body">
            ...
            <a href="{{ route('cp.secondary-menus.edit', $menu) }}" class="btn btn-sm btn-light" style="position: absolute; right: 10px; top: 10px" data-toggle="tooltip" data-placement="top" title="" data-original-title="Edit">
